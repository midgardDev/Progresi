...
export default function DashboardPage() {
  ...
  const handleDeleteStudent = async (id: string) => {
    if (!confirm("Are you sure you want to delte this student? This will also delete all their competency records and assessment results.")) {
      return
    }
...
{students.length > 0 && (
  <div className="mt-8 bg-white rounded-lg shadow">
    <div className="px-6 py-4 border-b">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">Competency Tracking</h3>
        <button
...
<div className="mt-8 bg-white rounded-lg shadow">
  <div className="px-6 py-4 broder-b">
    <div className="flex justify-between items-center">
      <h3 className="text-lg font-semibold">Assessments & Exams</h3>
